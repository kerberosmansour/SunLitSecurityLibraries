...
| 2 | Fill evidence pointers; document waivers with compensating controls; cross-link from THREAT_MODEL.md | `done` | 2026-05-06 | 2026-05-06 | [`docs/slo/lessons/anssi-m2.md`](../lessons/anssi-m2.md) | [`docs/slo/completion/anssi-m2.md`](../completion/anssi-m2.md) — 61 rows classified; 27 compliant / 7 partial / 2 waived / 25 N/A; THREAT_MODEL and README cross-linked. Closes #19. |
