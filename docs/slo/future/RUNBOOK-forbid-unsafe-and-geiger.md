...
| 2 | Add `cargo-geiger` to supply-chain CI lane; publish workspace unsafe number; document threshold | `done` | 2026-05-05 | 2026-05-05 | [`docs/slo/lessons/fug-m2.md`](../lessons/fug-m2.md) | [`docs/slo/completion/fug-m2.md`](../completion/fug-m2.md) — geiger 0.13.0 advisory CI lane; baseline 22 636 / 48 192 (root = secure_reference_service, all-features); threshold = baseline + 10 %. Closes #17. |
